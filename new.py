...
banner = html.Div([
            dbc.Row([dbc.Col(html.Div(html.Img(src=PLOTLY_LOGO, height="50px"))),
                dbc.Col(html.Div(html.H5("SMARTTRAK DASHBOARD",style={'fontSize':'40px','margin-right':'6rem','font-style': 'Georgia', 'font-weight': 'bold','color':'white'})))])])
        ...
        children=[dbc.DropdownMenu(nav=True,in_navbar=True,label="Main Control Room",
            ...
            dbc.DropdownMenu(nav=True,in_navbar=True,label="Trackers",
                    ...
                    ,html.A(dbc.Button("PlantView",color="primary",className="m-2 2 2 2",href="/page-9",size="sm")),
                        ...
                        html.A(dbc.Button("Alarms",color="primary",className="m-2 2 2 2",href="/page-14",size="sm"))],className="m-2 2 2 2",style={'border':'2px blue solid','margin':'3rem 3rem 3rem 3rem'})]),html.Div(id="page-content",style=CONTENT_STYLE1)],style=CONTENT_STYLE)
...
card_1 =  html.Div([dbc.Row([dbc.Col(html.A(dbc.Button("Trackers", id="tracker-button",href="/page-1",color="primary",className="mt 2")),style={"margin-top":"2rem"})])
    ,html.Br(),dbc.Container([dbc.Row([html.H4("TRACKER Devices",style={'color':'white'},className="mr-1")]),
...
html.A(html.Button("K6",className="mr-1"),href="/page-2")],style={"border":"2px darkblue solid",'width':'auto'})])
...
card_2 = html.Div([dbc.Row([dbc.Col(html.A(dbc.Button("SMB's", id="SMB-button",href="/page-5",color="primary",className="mt 2")),style={"margin-top":"2rem"})])
    ,html.Br(),dbc.Container([dbc.Row([html.H4("SMB Devices",style={'color':'white'},className="mr-1")]),
...
html.A(html.Button("K6",className="mr-1"),href="/page-6")],style={"border":"2px darkblue solid",'width':'auto'})])
...
#app.layout = html.Div([banner,row1,dcc.Location(id='url', refresh=False)])    
app.layout = html.Div(id="big-app-container",
        children=[
            banner,row1,dcc.Location(id='url', refresh=False)],style={'backgroundColor':'black'})    
...
page_2_graph =html.Div([html.A(dbc.Button("Home",color="success",className="mr-4"),href="/page-2"),
    html.A(dbc.Button("Status",color="success",className="mr-4"),href="/page-8"),
    html.A(dbc.Button("Location Setup",color="success",className="mr-4"),href="/page-4"),
    html.A(dbc.Button("Control",color="success",className="mr-4"),href="/page-7"),
    html.A(dbc.Button("Tracker Table",color="success",className="mr-4"),href="/page-1"),
...
page_9_PV  = html.Div([dbc.Container([
    ...
    dbc.Row([dbc.Col([
        dbc.Card([
            dbc.CardImg(src="https://www.ijser.org/paper/AUTOMATIC-SOLAR-TRACKER-SYSTEM/Image_001.jpg",top=True),
            dbc.CardBody([html.Div("Radiation Fixed: "),html.Div("Radiation Tilt:"),html.Div("Irradiation Fixed:"),html.Div("Irradiation Tilt:"),html.Div("Ambient Temp:"),html.Div("Module Temp:") ])],style={'width':"12rem",'margin-top':'2rem','margin-bottom':'1rem'}),]),
        dbc.Col([
        dbc.Card([
            dbc.CardImg(src="https://www.thehindubusinessline.com/economy/rzr7zz/article25225380.ece/alternates/FREE_435/SOLARPOWER",top=True),
            dbc.CardBody([html.Div("DC Power:"),html.Div("Max.DC Power:")  ])],style={'width':"12rem",'margin-top':'2rem','margin-bottom':'1rem'}),]),
            dbc.Col([
        dbc.Card([
            dbc.CardImg(src="",top=True),
            dbc.CardBody([html.Div("AC Power:"),html.Div("Max.AC Power:"),html.Div("Today Energy:"),html.Div("Total Energy:")  ])],style={'width':"12rem",'margin-top':'2rem','margin-bottom':'1rem'}),]),

        dbc.Col([
        dbc.Card([
            dbc.CardImg(src="https://qph.fs.quoracdn.net/main-qimg-3c4f4436e607f6b880427fed496f491c",top=True),
            dbc.CardBody([html.Div("Today IMPORT:"),html.Div("Today EXPORT:"),html.Div("Life IMPORT:"),html.Div("Life EXPORT:")  ])],style={'width':"12rem",'margin-top':'2rem','margin-bottom':'1rem'}),]),

        dbc.Col([
            dbc.Card([dbc.CardBody([html.Div("TO 100/120 KV ******Substation", style={'color':'maroon'})  ])],style={'width':"12rem",'border':'2px maroon solid','margin-top':'2rem','margin-bottom':'1rem'}),]),
...
page_16_InverterRoom1=html.Div([
    dbc.Row([dbc.Container([
        dbc.Row([dbc.Card([
            dbc.Col([
                daq.Indicator(label="DC Switch",color="green",value=True)])],style={'width':'15rem','height':'4rem'}),
    dbc.Card(dbc.Col([daq.Indicator(
        label="SPD Status",color="green",value=True)]),style={'width':'15rem','height':'4rem'})]),html.Br(),html.Br(),
    dbc.Row([dbc.Col([
        dbc.Card([dbc.Col([html.H6("DC Voltage",style={'margin':'1rem','textAlign':'center','fontSize':"15px"}),html.Div("0 V",style={'margin':'1rem','textAlign':'center','fontSize':"20px"})])],style={'width':'15rem'})])
    ,dbc.Card([dbc.Col([html.H6("Sum of Currents",style={'margin':'1rem','textAlign':'center','fontSize':"15px"}),html.Div("0 A",style={'margin':'1rem','textAlign':'center','fontSize':"20px"})])],style={'width':'15rem'})]),html.Br(),html.Br(),
    dbc.Card(dbc.Col([html.H6("Power",style={'margin':'1rem','textAlign':'center','fontSize':"20px"}),html.Div("0.000 KW",style={'margin':'1rem','textAlign':'center','fontSize':"20px"})]))],style={"border":"2px darkblue solid",'width':'auto','margin':'2rem 2rem 2rem 2rem'}),
    dbc.Col(html.Table(stringtable()))
    ]),dcc.Link(href='/page-16')])
